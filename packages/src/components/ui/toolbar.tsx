 ...
 * ```
 */
export const Toolbar = ({ children }: BaseProps) => {
 ...
 * ```
 */
export const ToolbarHeading = ({ children, className }: BaseProps) => {
 ...
 * ```
 */
export const ToolbarTitle = ({ className, children }: BaseProps) => {
 ...
 * ```
 */
export const ToolbarActions = ({ children }: BaseProps) => {
