...
```bash
# Using bun
bun add @pelatformui/default

# Using npm
npm install @pelatformui/default
```

### Peer Dependencies

```bash
bun add @pelatformui/general @pelatformui/hook @radix-ui/react-dialog lucide-react next-themes radix-ui react-hook-form sonner
```
