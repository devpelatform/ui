  ...
  return (
    ...
    >
        ...
        <ComboboxTrigger
          render={
            <Button
              ...
              className={cn(
                [
                  "flex w-16 gap-1 rounded-s-md rounded-e-none border-e-0 px-3 focus:z-10",
                  "shadow-black/5 shadow-xs",
                ],
                disabled && "opacity-50",
              )}
              disabled={disabled}
      ...
      <ComboboxContent className={cn("w-[300px] overflow-hidden", popupClassName)}>
        ...
        />
        <ComboboxSeparator />
        <ComboboxEmpty className="px-2 pt-4 pb-2 text-center">No country found.</ComboboxEmpty>
...
function FlagComponent({ country, countryName }: BasePhoneInput.FlagProps) {
  ...
  return (
    <span className="flex h-4 w-6 overflow-hidden rounded-sm bg-foreground/10 [&_svg:not([class*='size-'])]:size-full!">
