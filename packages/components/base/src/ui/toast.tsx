...
import { cn, cva } from '@pelatformui/general';
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          {type && TOAST_ICONS[type] && (
                            <div
                              className="shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
                        ...
                        {(toast.data?.close || showCloseButton) && (
                          <Toast.Close
                            className={cn(
                              'absolute end-2 top-2 cursor-pointer [&_svg]:size-3.5 [&_svg]:opacity-60 hover:[&_svg]:opacity-100',
                            )}
