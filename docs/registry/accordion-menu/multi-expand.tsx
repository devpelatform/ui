...
import { Briefcase, CircleCheck, LifeBuoy, Mail, Settings, User } from 'lucide-react';
...
export default function AccordionMenuWithSubmenusDemo() {
  return (
    <div className="w-full overflow-hidden rounded-md border border-border p-2 md:w-[250px]">
      <AccordionMenu
        type="multiple"
